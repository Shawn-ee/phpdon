...
class IndexDynamicCoach extends ApiRest
{
    ...
    public function dynamicInfo(){
        ...
        //技师情况
        $data['coach_info'] = $this->model->where(['id'=>$data['coach_id']])->field('coach_name,work_img,is_work,work_time')->find();
        ...
        // var_dump($this->list_model->getCommentNum($dis));die;
        // //评论数量
        ...
        // $data['comment_num'] = rand(111111,66666);
        // //点赞数量
        // $data['thumbs_num']  = rand(111111,66666);
        //评论数量
