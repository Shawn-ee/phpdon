...
class TagSet
{
     ...
     * @return bool
     */
    public function inc(string $name, $value, $expire = null): bool
    {
        $this->handler->inc($name, $value, $expire);
     ...
     * @return bool
     */
    public function dec(string $name, $value, $expire = null): bool
    {
        $this->handler->dec($name, $value, $expire);
